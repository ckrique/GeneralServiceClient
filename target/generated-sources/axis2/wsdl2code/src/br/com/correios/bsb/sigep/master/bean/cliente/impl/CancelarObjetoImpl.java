 ...
 */
public class CancelarObjetoImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.correios.bsb.sigep.master.bean.cliente.CancelarObjeto
{
    
    public CancelarObjetoImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName IDPLP$0 = 
        new javax.xml.namespace.QName("", "idPlp");
    private static final javax.xml.namespace.QName NUMEROETIQUETA$2 = 
    ...
    public long getIdPlp()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(IDPLP$0, 0);
            if (target == null)
            {
                return 0L;
            }
    ...
    public org.apache.xmlbeans.XmlLong xgetIdPlp()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlLong)get_store().find_element_user(IDPLP$0, 0);
            return target;
        }
    }
    ...
    public boolean isSetIdPlp()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(IDPLP$0) != 0;
        }
    }
    ...
    public void setIdPlp(long idPlp)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(IDPLP$0);
            }
    ...
    public void xsetIdPlp(org.apache.xmlbeans.XmlLong idPlp)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlLong)get_store().add_element_user(IDPLP$0);
            }
            target.set(idPlp);
        }
    }
    ...
    public void unsetIdPlp()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(IDPLP$0, 0);
        }
    }
    ...
    public java.lang.String getNumeroEtiqueta()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(NUMEROETIQUETA$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetNumeroEtiqueta()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(NUMEROETIQUETA$2, 0);
            return target;
        }
    }
    ...
    public boolean isSetNumeroEtiqueta()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(NUMEROETIQUETA$2) != 0;
        }
    }
    ...
    public void setNumeroEtiqueta(java.lang.String numeroEtiqueta)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(NUMEROETIQUETA$2);
            }
    ...
    public void xsetNumeroEtiqueta(org.apache.xmlbeans.XmlString numeroEtiqueta)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(NUMEROETIQUETA$2);
            }
    ...
    public void unsetNumeroEtiqueta()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(NUMEROETIQUETA$2, 0);
        }
    }
